...
1.* A colored pixel (red, green or black) has been found and also :
1.** the pixel behind is also colored
1.** the pixel in front is also colored
1.** the relative distance to the center is less then 98% (100% = half height of the picture)
2.* or the relative distance to the center is less then 60% (100% = half height of the picture)
